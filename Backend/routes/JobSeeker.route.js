...
import { getAdminAllJobs, getAllApplication, getAllCompany, getAllJobs, getAllUsers, getAppliedJobs, getJobDetail, register, registerInterviewer, updateJobSeekers } from "../controller/JobSeeker.controller.js";
...
router.get("/getalladminjobs",verifyToken,getAdminAllJobs);
