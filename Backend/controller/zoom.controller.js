...
const createZoomMeeting = async (req, res) => {
  ...
  try {
    ...
    const formattedTime = moment(startTime).utc().format("YYYY-MM-DDTHH:mm:ss[Z]");
    ...
    const response = await axios.post(
      "https://api.zoom.us/v2/users/me/meetings",
      {
        ...
        start_time: formattedTime, // Format: YYYY-MM-DDTHH:mm:ssZ (UTC)
        duration,
    ...
    const interviewss = await Interview.create({
      job_id: job_id,
